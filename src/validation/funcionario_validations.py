...
def validate_funcionario(data: dict, id_is_required=False):
    schema = {
        ...
        "funcao": {"type": "string", "maxlength": 50, "required": True},
...
def validate_funcionario_optional_fields(data: dict):
    ...
    schema = {
        ...
        "sobre_nome": {"type": "string", "maxlength": 100, "required": False},
        "funcao": {"type": "string", "maxlength": 50, "required": False},
